...
const SideBar = () => {
  ...
  return (
    <div className="openSbar flex flex-col sticky top-0 overflow-y-scroll border-r w-[15rem] min-w-fit h-screen pt-3">
      <div className="Firstlist flex pl-2 flex-col font-semibold text-sm w-[15rem] ">
        ...
        <div className="Shorts px-2 flex py-2 items-center hover:bg-zinc-100 w-full rounded-lg cursor-pointer pt-2">
          <img className="w-9 mr-2 mb-1 " src={ShortsLogo} alt="ShortLogo" />
          <span>Shorts</span>
        </div>
